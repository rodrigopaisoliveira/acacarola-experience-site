      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          {[
            ...
            <div key={partner.name} className="flex items-center justify-between py-6 px-4 border-t border-border">
              ...
              <div className="w-10 h-10 rounded-full bg-foreground text-background flex items-center justify-center cursor-pointer hover:bg-foreground/80 transition-colors">
