    ...
    <div>
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 px-6">
          <img src={logoWhite} alt="A Caçarola — Restaurante" className="mx-auto w-56 sm:w-64 md:w-80 lg:w-96 drop-shadow-lg relative -translate-x-[14px] sm:-translate-x-[16px] md:-translate-x-[20px] lg:-translate-x-[24px]" width={400} height={400} />
          <Link to="/reservas">
