    ...
    <div>
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 px-6">
          <img src={logoWhite} alt="A Caçarola — Restaurante" className="mx-auto w-64 sm:w-72 md:w-96 lg:w-[28rem] drop-shadow-lg translate-x-[28px] sm:translate-x-[32px] md:translate-x-[46px] lg:translate-x-[54px]" width={400} height={400} />
          <Link to="/reservas">
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="https://maps.app.goo.gl/YourRestaurantLink" target="_blank" rel="noopener noreferrer" className="relative rounded-2xl overflow-hidden h-64 md:h-80 group cursor-pointer block">
