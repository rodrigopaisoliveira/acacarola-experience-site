    ...
    <div>
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 px-6">
          <img src={logoWhite} alt="A Caçarola — Restaurante" className="mx-auto w-64 sm:w-72 md:w-96 lg:w-[28rem] drop-shadow-lg translate-x-[22px] sm:translate-x-[26px] md:translate-x-[34px]" width={400} height={400} />
          <Link to="/reservas">
