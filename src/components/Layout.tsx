        ...
        <div className="max-w-6xl mx-auto px-6 py-14 md:py-18">
          ...
          <div className="border-t border-border/50 pt-6 flex flex-col items-center gap-5">
            <div className="flex gap-3">
              ...
              <a href="https://www.tripadvisor.pt/Restaurant_Review-g189158-d6673445-Reviews-Novo_Edmundo-Lisbon_Lisbon_District_Central_Portugal.html" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-border text-muted-foreground flex items-center justify-center hover:bg-muted hover:text-foreground transition-colors">
